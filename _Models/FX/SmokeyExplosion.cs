...
{
	internal class SmokeyExplosion : AnimatedSprite
	{
		public bool isAnimationComplete { get; set; } = false;
		public SmokeyExplosion(Texture2D texture, Vector2 position, int frames, bool loop) : base(texture, position, frames, loop)
		{
